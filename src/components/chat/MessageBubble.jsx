...
export default function MessageBubble({
  ...
  const renderContent = () => {
    switch (message.type) {
        ...
        return (
          <div className="message-bubble__document">
            ...
            <div className="message-bubble__doc-info">
              <span className="message-bubble__doc-name">
                {message.fileName}
              </span>
            </div>
          </div>
      ...
      case MESSAGE_TYPES.STICKER:
        return (
          <div className="message-bubble__sticker">{message.text || "👍"}</div>
        );

      case MESSAGE_TYPES.SYSTEM:
        return <div className="message-bubble__system">{message.text}</div>;
  ...
  return (
    ...
    >
      {message.replyTo && (
        <div className="message-bubble__quoted">
          <div className="message-bubble__quoted-border" />
          <div className="message-bubble__quoted-content">
      ...
      {isGroup && senderName && !isOwn && !grouped && (
        <div className="message-bubble__sender">{senderName}</div>
      )}
      {renderContent()}
