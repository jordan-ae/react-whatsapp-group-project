...
export default function SidebarHeader() {
  ...
  return (
    <div className="sidebar-header">
      {/* RESTORED: Profile button wrapper using dynamic main logic */}
      <button 
        className="sidebar-header__avatar-btn" 
      ...
      <div className="sidebar-header__actions">
        ...
        <button className="sidebar-header__btn" title="New chat" onClick={OpenNewChat}>
          <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
        ...
        <div className="menu-container">
          {menuOpen && (
            <div className="dropdown-menu">
              {/* FIXED: setmenu(false) changed to setMenuOpen(false) */}
              <Link to="/profile" className="dropdown-item" onClick={() => setMenuOpen(false)}>View Profile</Link>
